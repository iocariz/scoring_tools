...
- **Management Results Deck**: A ~9-slide executive `.pptx` built from the consolidated results — headline production/risk, per-segment charts, the swap-in/swap-out bridge, acceptance change, 2D + 3D risk surfaces, and out-of-time validation — with a data-driven recommendation narrative.
