...
def calculate_metrics_from_cuts(
    ...
    try:
        ...
        row_actual = {
            ...
            "Production (%)": 100.0,  # true percent (% of Actual), matching the "0.00" format
        ...
        row_si = {
            ...
            "Risk (%)": si_risk,
            "Production (€)": si_prod,
            "Production (%)": 100.0 * si_prod / actual_prod if actual_prod else 0,
        ...
        row_so = {
            ...
            "Risk (%)": so_risk,
            "Production (€)": so_prod,
            "Production (%)": 100.0 * so_prod / actual_prod if actual_prod else 0,
        ...
        row_opt = {
            ...
            "Risk (%)": opt_risk,
            "Production (€)": opt_prod,
            "Production (%)": 100.0 * opt_prod / actual_prod if actual_prod else 0,
